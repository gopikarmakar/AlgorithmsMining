...
public class WordBreak2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(split(s, new HashSet<>(Arrays.asList(dict))));
	}
	
	/**
	 * First method
	 * Since we skip the nested loop several times but we still 
	 * fetch the substring same times for the valid chars.
	 * i.e the time complexity will be above O(n^2).
	 */
	private static List<String> split(String s, Set<String> dict) {
